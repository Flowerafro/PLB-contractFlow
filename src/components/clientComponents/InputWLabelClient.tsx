export function InputWLabelClient({value, onChange, label, type = "text", name, id, required = false}: {value: string; onChange: (e: React.ChangeEvent<HTMLInputElement>) => void; label: string; type?: string; name: string; id: string; required?: boolean}) {
