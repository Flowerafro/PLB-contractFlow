 ...
 * Seeds the local D1 database with comprehensive sample data for testing
 * Based on data from hoved_listen_paa_lissom.json
 */
...
async function seedDatabase() {
  ...
  try {
    ...
    if (!hasData) {
      ...
      // Step 3: Add contracts (20 contracts for 20 shipments)
      ...
      // Step 4: Add shipments (20 shipments)
      ...
      // Step 5: Add invoices (20 invoices)
