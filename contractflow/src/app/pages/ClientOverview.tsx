      ...
      <section className="bg-white rounded-lg border border-black/10 overflow-hidden">
        {searchClient ? (
          filteredClients.length === 0 ? (
            ...
            <ClientDetailView filteredClients={filteredClients} />
          )
        ) : (
          <>
            <div className="px-6 py-4" style={{ backgroundColor: "#f8f8f8" }}>
              <h3 style={{ margin: 0, color: "#1E1E1E" }}>Customer Register</h3>
              <p style={{ margin: 0, marginTop: 4, opacity: 0.6 }}>Click any row to view detailed client information</p>
            </div>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", background: "#fff" }}>
                ...
                <tbody>
                  {clientDisplay.map(client => (
                    ...
                    >
                      <td style={{ padding: 8 }}>{client.clientNo}</td>
